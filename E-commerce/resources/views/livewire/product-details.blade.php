                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{asset('user-interface/imgs/shop/product-')}}{{$product->id}}-2.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{asset('user-interface/imgs/shop/product-')}}{{$product->id}}-1.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{asset('user-interface/imgs/shop/product-')}}{{$product->id}}-3.jpg" alt="product image">
                                            </figure>

                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="{{asset('user-interface/imgs/shop/thumbnai')}}{{$product->id}}3.jpg" alt="product image"></div>
                                            <div><img src="{{asset('user-interface/imgs/shop/thumbnai')}}{{$product->id}}4.jpg" alt="product image"></div>
                                    ...
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-facebook">
                                                <a href="#"><img src="{{asset('user-interface/imgs/theme/icons/i')}}{{$product->id}}n-facebook.svg" alt=""></a>
                                            </li>
                                            <li class="social-twitter">
                                                <a href="#"><img src="{{asset('user-interface/imgs/theme/icons/i')}}{{$product->id}}n-twitter.svg" alt=""></a>
                                            </li>
                                            <li class="social-instagram">
                                                <a href="#"><img src="{{asset('user-interface/imgs/theme/icons/i')}}{{$product->id}}n-instagram.svg" alt=""></a>
                                            </li>
                                            <li class="social-linkedin">
                                                <a href="#"><img src="{{asset('user-interface/imgs/theme/icons/i')}}{{$product->id}}n-pinterest.svg" alt=""></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="short-desc mb-30">
                                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam rem officia, corrupti reiciendis minima nisi modi, quasi, odio minus dolore impedit fuga eum eligendi? Officia doloremque facere quia. Voluptatum,
                                                accusantium!</p>
                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="comment-list">
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{asset('user-interface/imgs/page/avatar-6')}}{{$product->id}}pg" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{asset('user-interface/imgs/page/avatar-7')}}{{$product->id}}pg" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{asset('user-interface/imgs/page/avatar-8')}}{{$product->id}}pg" alt="">
                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="product-details.html" tabindex="0">
                                                            <img class="default-img" src="{{asset('user-interface/imgs/shop/product-')}}{{$product->id}}-1.jpg" alt="">
                                                            <img class="hover-img" src="{{asset('user-interface/imgs/shop/product-')}}{{$product->id}}-2.jpg" alt="">
                                                        </a>
                                                    </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('user-interface/imgs/shop/product-')}}{{$product->id}}-1.jpg" alt="#">
                                </div>
